...
parser.add_argument("--output_dir", default='output/save_dict/', type=str,
...
def test_entry():
    ...
    for i, batches in enumerate(loader):
        ...
        if config.model == "PMI":
            input_ids, attention_mask, masked_head, masked_tail, masked_both = gettoken_pmi(config, subject, object,
                                                                                            predicate)
